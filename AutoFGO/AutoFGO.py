...
#Menu mulai
diam = False
hasil = str(input("Mulai? (Y/N): "))
stamina = 0


if hasil == "Y" or hasil == "y":
    repeat = 0
...
if maw == "N" or maw == "n" and diam == False:
    ...
    while True:
        try:
            ...
            p1,l1 = pyg.locateCenterOnScreen('Y:\piton_kode\PersonalProj\AutoFGO\\Gate.jpg', region=(0,0,1856,1920), confidence = 0.7)
            click(p1,l1)
            break
        except:
            click(960,540)
    ...
    while True:
        try:
            tungguGlobal()
            dailyX,dailyY = pyg.locateCenterOnScreen('Y:\piton_kode\PersonalProj\AutoFGO\\Quest.jpg', region=(0,0,1856,1920), confidence = 0.7)
            click(dailyX,dailyY)
            break
        except:
            click(1761,222)
...
#Main Farming Loop
while repeat != ulang and key.is_pressed('z') == False and diam == False:
    #balik ke window fgo
    ...
    while True:
        try:
            m1,m2 = pyg.locateCenterOnScreen('Y:\piton_kode\PersonalProj\AutoFGO\\mage.jpg', region=(0,0,1856,1920), confidence = 0.8)
            tungguGlobal()
            tungguGlobal()
            tungguGlobal()
            click(m1,m2)
...
#cari gambar zhuge liang/waver kalau gak ada skrol ke bawah (cek terus sampe bawah, kalo gak ada klik update list)
    ...
    while True:
        try:
            ...
            tungguGlobal()
            cekWaver1X,cekWaver1Y = pyg.locateCenterOnScreen('Y:\piton_kode\PersonalProj\AutoFGO\\Waver2.jpg', region=(0,0,1856,1920), confidence = 0.8)
            tungguGlobal()
            ...
            try:
                tungguGlobal()
                cekWaver2X,cekWaver2Y = pyg.locateCenterOnScreen('Y:\piton_kode\PersonalProj\AutoFGO\\Waver1.jpg', region=(0,0,1856,1920), confidence = 0.8)
                tungguGlobal()
    ...
    while True:
        try:
            s1,s2 = pyg.locateCenterOnScreen('Y:\piton_kode\PersonalProj\AutoFGO\\Utama.jpg', region=(0,0,1856,1920), confidence = 0.9)
            click(s1,s2)
            print("Gasskeun Bang!")
            break
        except:
    ...
    while True:
        try:
            a1,a2 = pyg.locateCenterOnScreen('Y:\piton_kode\PersonalProj\AutoFGO\\Utama.jpg', region=(0,0,1856,1920), confidence = 0.9)
            click(a1,a2)
            print("Lanjutkeun!")
            break
        except:
    ...
    while True:
        try:
            a1,a2 = pyg.locateCenterOnScreen('Y:\piton_kode\PersonalProj\AutoFGO\\Utama.jpg', region=(0,0,1856,1920), confidence = 0.8)
            click(a1,a2)
            print("Lanjutkeun!")
            break
        except:
    ...
    while True:
        try:
            x,y = pyg.locateCenterOnScreen('Y:\piton_kode\PersonalProj\AutoFGO\\Done.jpg', region=(0,0,1856,1920), confidence = 0.8)
            click(x,y)
...
## Jika supportnya bukan friend
    while True:
        try:
            ...
            pyg.locateCenterOnScreen('Y:\piton_kode\PersonalProj\AutoFGO\\Support.jpg', region=(0,0,1856,1920), confidence = 0.9)
            click(438,915)
            tungguGlobal()
            #klik repeat
            click(1165,852)
